<?php
        $plugins_list = array(
                'adminify-notification-bar' => array(
                    'slug'              => 'adminify-notification-bar',
                    ...
                    'icon'              => 'https: //raw.githubusercontent.com/litonarefin/adminify-addons-assets/main/adminify-notification-bar/icon.svg',
                    'download_link'     => 'https: //rnd.local/wp-content/adminify-update-checker/?plugin_slug=adminify-notification-bar&action=download_plugin&version=1.0.2',
                ...
                'adminify-notification-bar' => array(
                    ...
                    'short_description' => 'Gutenberg is now a reality. Easy Blocks is a growing Gutenberg Block Plugin. It’s easy to create multiple columns variations within a single row. Drag and Drop columns size variations gives you more controls over your website. We’re calling it as a Gutenberg Page Builder. If you are using Gutenberg Editor, then you can try this plugin to get maximum customization possibilities.',
                    'icon'              => 'https: //raw.githubusercontent.com/litonarefin/adminify-addons-assets/main/adminify-notification-bar/icon.svg',
                    'download_link'     => 'https: //adminify.local/update-checking/?plugin_slug=adminify-notification-bar&action=download_plugin&version=1.0.2',
                    'type'              => array('all', 'featured', 'favorites'),
                    'version'            => '1.0.2'
                ),
